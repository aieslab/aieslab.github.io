...
<!-- TODO: Implement carousel with navigation dots for research areas -->
<!-- Each slide should include an image and description -->

### Industrial Cooling and HVAC Optimization

Control and optimisation of chilled-water plants, cooling towers, and HVAC systems, with an emphasis on hybrid and physics-guided approaches for efficient operation.

### Semantic and AI-Based Tools for Energy Systems

Semantic models, structured data representations, and AI tools that make energy systems easier to understand, integrate, and operate.
...
Our work focuses on how advanced control and AI can be made reliable and practical enough for real buildings, HVAC systems, industrial cooling, and data centres. A central part of the lab's approach is working with realistic data and real equipment, often through collaboration with industry partners.
