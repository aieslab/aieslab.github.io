...
<div class="row align-items-center mb-4">
  <div class="col-md-8">
    <p class="lead">
      Welcome to the Autonomous and Intelligent Energy Systems Lab! We work on advanced control and AI methods for buildings, HVAC systems, industrial cooling, and data centers. Our research focuses on reinforcement learning, model predictive control, and physics-informed approaches that can be deployed in real world.
    </p>
    <p>
      Our goal is to bridge the gap between research and real-world adoption. We provide opportunities for researchers to work on real systems through active industry collaborations.
    </p>
    <p>
      <strong>Want to work with us?</strong> Visit our <a href="/join/">Join</a> page or <a href="#contact">contact us</a> directly.
    </p>
  </div>
  <div class="col-md-4">
    <img src="{{ '/assets/img/lab-hero.png' | relative_url }}" class="img-fluid rounded shadow" alt="AIES Lab">
  </div>
</div>
...
<div class="row row-cols-1 row-cols-md-3 g-4 mb-4">
  <div class="col">
    <div class="card h-100">
      <img src="{{ '/assets/img/research/hvac.gif' | relative_url }}" class="card-img-top" alt="HVAC">
      <div class="card-body">
        <h5 class="card-title">Industrial Cooling and HVAC Optimization</h5>
        <p class="card-text">
